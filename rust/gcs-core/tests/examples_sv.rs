...
const DOCS: &[(&str, Shape, i64, State)] = &[
    ...
    ("vtwin", (321, 270, 24, 4), 1, State::Under),
    ("vtwin_cylinder", (69, 50, 2, 0), 0, State::Well),
    ("vtwin_plate", (166, 141, 13, 4), 0, State::Well),
    ("vtwin_piston", (56, 40, 3, 0), 0, State::Well),
    ("vtwin_disc", (59, 49, 5, 0), 0, State::Well),
    ("vtwin_flywheel", (49, 40, 3, 0), 0, State::Well),
    ("vtwin_throttle", (63, 53, 4, 0), 0, State::Well),
];
