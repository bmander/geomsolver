...
export const claimsEl = document.getElementById('claims') as HTMLElement;
export const claimsText = document.getElementById('claims-text') as HTMLElement;
export const claimsSelect = document.getElementById('claims-select') as HTMLButtonElement;
